...
public class UnwrappedActivity extends AppCompatActivity {
    ...
    private static final String AccessTokenKey ="ACCESS_TOKEN_KEY";
    private Button buttonThisWeek, buttonLastSixMonths, buttonThisYear, tracksButtonThisWeek, tracksButtonLastSixMonths, tracksButtonThisYear,
            unwrapYourMusicButton;
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private TextView textViewYourTopArtists, textViewYourTopTracks, tokenTextView;
...
//        editor = SharedPreferences.edit();
        ...
        //text views for top artists and tracks and token
        tokenTextView = (TextView) findViewById(R.id.textViewYourTopArtists);
        ...
        //Buttons for time ranges for top artists and token
       /* Button unwrapYourMusicButton = (Button) findViewById(R.id.unwrapYourMusicButton);*/
        ...
        //On click listeners for buttons for top artists and token

        unwrapYourMusicButton.setOnClickListener((v) -> {
            getToken();
        });
   ...
   /* getToken();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (AUTH_TOKEN_REQUEST_CODE == requestCode) {
            ...
            Log.i(" ", "access token from variable" + mAccessToken);
            ...
            setTextAsync(mAccessCode, tokenTextView);
        }
    }
    private void setAccessToken(){
        editor.putString(AccessTokenKey, mAccessToken);
    }
    ...
    private AuthorizationRequest getAuthenticationRequest(AuthorizationResponse.Type type) {
        return new AuthorizationRequest.Builder(CLIENT_ID, type, getRedirectUri().toString())
                .setShowDialog(false)
                .setScopes(new String[]{"user-read-email", "user-top-read", "playlist-read", "playlist-read-private", "streaming"}) // <--- Change the scope of your requested token here
        ...
        mCall.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    final JSONObject jsonObject = new JSONObject(userTopArtistWeek);
                    //List<String> artistNames = parseArtistNames(jsonObject);
                    setTextAsync(jsonObject.toString(3), textViewYourTopArtists);
                } catch (JSONException e) {
                    Log.d("JSON", "Failed to parse data: " + e);
                    runOnUiThread(() -> {
                       // adapter.setArtists(artistNames); // Or the method you have for updating artists in your adapter
